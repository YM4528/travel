    ...
    <form class="mt-5" action="../../controllers/UserController.php" method="POST">
      ...
      <div class="form-group">
        <div class="row">
          ...
          <input type="text" name="username" class="form-control col-md-8" id="username" value="<?php echo $userData['username'] ?>">
          <?php
      ...
      <div class="form-group">
        <div class="row">
          ...
          <input type="text" name="email" class="form-control col-md-8" id="email" value="<?php echo $userData['email'] ?>">
          <?php
